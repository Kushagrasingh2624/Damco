...
public static String subject = "Damco";
	...
	@FindBy(xpath="(//span[text()='Damco']/parent::span/ancestor::td/preceding-sibling::td[@role='gridcell'])[1]")
	private WebElement draftedMail;
	
	@FindBy(xpath="(//span[text()='Damco']/parent::span/ancestor::td/preceding-sibling::td[@role='gridcell'])[2]")
	...
	@FindBy(xpath="//*[@class='bog']/span[text()='Damco']/ancestor::td/parent::tr")
	private WebElement receivedMail;
	
	@FindBy(xpath="//*[@class='bog']/span[text()='Damco']/ancestor::td/following-sibling::td/span/span")
	...
	public void gmailLogin()
	{
		...
		{
			System.out.println();
			UserIDTextBox.sendKeys("kushagr4321@gmail.com");
			NextButton.click();
			waitForVisibility(PasswordTextBox,10);
			PasswordTextBox.sendKeys("kush@1234");
			NextButton.click();
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	public void openDraftMailandSend() {
		try {
			...
			toField.sendKeys("kushagr4321@gmail.com");
